                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="table-responsive mt-3">
                                ...
                                ?>
                                    <p class="text-danger fst-italic">*anda dapat melihat data alternatif (data benih tomat) yang telah di tambahkan oleh admin secara detail dengan cara klik logo "mata" pada tabel detail.</p>
                                    <p class="text-danger fst-italic">*anda dapat menambahkan data alternatif (data benih tomat) yang anda ketahui, dengan cara menekan tombol "Tambah Data". Setelah itu, Anda dapat mengisi nama alternatif (nama benih tomat), lokasi dataran, umur panen, potensi hasil, potensi berat dan ketahanan penyakit yang dapat dilihat pada belakang kemasan benih tomat tersebut. <a href="#" data-bs-toggle="modal" data-bs-target="#sample">Klik disini</a> untuk melihat contoh dari belakang kemasan untuk mengisi kriteria.</p>
                                <?php
                                }
                                ?>
