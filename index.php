...
<head>
    ...
    <title>Rekomendasi Benih Tomat</title>
    <!-- Favicon-->
...
<body id="page-top">
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100">
                ...
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5">Rekomendasi Benih Tomat Menggunakan Metode Simple Multi Attribute Rating Technique (SMART)</p>
    ...
    <section class="page-section" id="rekomendasi">
        <div class="container px-4 px-lg-5">
            ...
            ?>
            <p class="text-center mb-4">Berdasarkan hasil perhitungan Sistem Pendukung Keputusan dengan menggunakan metode SMART, didapatkan bahwa <span class="fw-bold">"<?= $data_rekom['nama_alternatif']; ?>"</span> adalah jenis benih tomat yang paling direkomendasikan untuk anda.</p>
            <div class="row gx-4 gx-lg-5">
                <div class="col-lg-12 text-center">
                    <div class="mt-5">
                        <div class="mb-2"><i class="bi-gem fs-1 text-primary"></i></div>
                        <h3 class="h4 mb-2">Pengurutan Peringkat Rekomendasi Benih Tomat</h3>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="text-white-75 mb-4">Panduan penggunaan sistem pendukung keputusan rekomendasi benih tomat dapat diunduh pada link di bawah ini.</p>
    ...
    <footer class="bg-light py-5">
        <div class="container px-4 px-lg-5">
            <div class="small text-center text-muted">Balai Pengkajian Teknologi Pertanian</div>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
